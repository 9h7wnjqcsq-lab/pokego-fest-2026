          ...
          {selectedLimitedTab === 0 ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <div style={{ background: "#fff", borderRadius: 100, padding: "4px" }}>
                <span style={{ display: "block", padding: "5px 12px", fontSize: 13, fontWeight: 700, color: "#333", fontFamily: "'Chakra Petch',sans-serif", textAlign: "center" }}>🏅 寶可夢中心　🐾 集章趣　👊🏻 團體戰熱點</span>
              </div>
